...
/**
 * PredictionSearch represents the model behind the search form about `app\models\Prediction`.
 */
class PredictionSearch extends Prediction
{
    public function rules()
    {
        return [
            [['id', 'created_by', 'modified_by'], 'integer'],
            [['s1', 's2', 's3', 's4', 's5', 's6', 's7', 's8', 's9', 'created_at', 'modified_at', 'status', 'remark'], 'safe'],
        ];
    }
