...
class TelegramHelperV1
{

    private static $ch; //cURL Handle
    private static $defaultChatId = -22139644; //bot common

    private static $groups = [
        'bot_common' => -22139644,
        'dev_chat' => -1001118941135,
        'official_nds' => -1001205897388,
        'bot_test' => -118356001,
        'error_log' => -194411044,
        'security_reports' =>  -1001166599914,
        'pendopo' =>  -362039536,
        'serverlifecheck' => -234538795,
        'bipo' => -402417323
    ];
    ...
    public static function replyKeyboardMarkup($params, $botToken = null)
    {
        return self::send('replyKeyboardMarkup', $params, $botToken);
    }
    
    public static function getMessageId($params, $botToken = null)
    {
        return self::send('getMessageId', $params, $botToken);
    }
