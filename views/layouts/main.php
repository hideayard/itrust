    ...
    <div class="">
        ...
        <div class="container">
            ...
            <div class="col-md-10 text-center">
                ...
                >Explore One of the <span class="hero-text-gradient">Featured Dashboard</span> Template in Themeforest</h1
                >
        ...
        <div class="technology-block">
            ...
            <li class="list-inline-item" data-bs-toggle="tooltip" data-bs-placement="top" title="Click to Preview Bootstrap 5"
                ...
                ><img src="assets/images/landing/tech-bootstrap.svg" alt="img" class="img-fluid" /></a
            ></li>
            <!--
            ...
            /></li>
            -->
            <li class="list-inline-item" data-bs-toggle="tooltip" data-bs-placement="top" title="Click to Preview React"
                ><a href="https://ableproadmin.com/react/" target="_blank"
                ><img src="<?= $baseUrl ?>/assets/images/landing/tech-react.svg" alt="img" class="img-fluid" /></a
            ></li>
            <li class="list-inline-item" data-bs-toggle="tooltip" data-bs-placement="top" title="Click to Preview React Material UI"
                ><a href="https://ableproadmin.com/react/" target="_blank"
                ><img src="<?= $baseUrl ?>/assets/images/landing/tech-mui.svg" alt="img" class="img-fluid" /></a
            ></li>
            <li class="list-inline-item" data-bs-toggle="tooltip" data-bs-placement="top" title="Click to Preview CodeIgniter"
                ...
                ><img src="<?= $baseUrl ?>/assets/images/landing/tech-codeigniter.svg" alt="img" class="img-fluid" /></a
            ></li>
            <li class="list-inline-item" data-bs-toggle="tooltip" data-bs-placement="top" title="Click to Preview ASP.net"
                ...
                ><img src="<?= $baseUrl ?>/assets/images/landing/tech-net.svg" alt="img" class="img-fluid" /></a
            ></li>
            <li class="list-inline-item" data-bs-toggle="tooltip" data-bs-placement="top" title="Figma Design System"
                ...
                ><img src="<?= $baseUrl ?>/assets/images/landing/tech-figma.svg" alt="img" class="img-fluid" /></a
            ></li>
            </ul>
        </div>
        </header>
        ...
        <div class="row align-items-center wow fadeInUp" data-wow-delay="0.2s">
          <div class="col-md-8">
            ...
            <p class="mb-4 mb-md-0"
              >Simply submit your email, we share you the top news related to Able Pro feature updates, roadmap, and news.</p
            >
          </div>
          <div class="col-md-4">
            <div class="row">
